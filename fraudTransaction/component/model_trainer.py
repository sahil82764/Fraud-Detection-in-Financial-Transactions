...
from fraudTransaction.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from fraudTransaction.entity.config_entity import ModelTrainerConfig
from fraudTransaction.util.util import load_numpy_array_data,save_object,load_object
from fraudTransaction.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from fraudTransaction.entity.model_factory import evaluate_classification_model
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            housing_model = FraudDetectionModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
